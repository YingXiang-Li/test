...
public class ChangeSimpleToTraditional {
			...
			if (files.length == 0) {
				...
				for (File file2 : files) {
					if (file2.isDirectory()) {
						...
						if (sbsolutePath.endsWith(".jsp") || sbsolutePath.endsWith(".js")
								|| sbsolutePath.endsWith(".html") || sbsolutePath.endsWith(".java")
								|| sbsolutePath.endsWith(".xml") || sbsolutePath.endsWith(".vue")) {
	...
	public static void main(String[] args) {
		changeFileFromSimpleChineseToTradionalWithRootPath("D:\\git\\FamilySchoolWebFront\\school_web\\src");
	}
}